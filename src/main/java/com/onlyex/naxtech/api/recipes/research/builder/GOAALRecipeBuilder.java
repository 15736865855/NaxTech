...
public class GOAALRecipeBuilder extends RecipeBuilder<GOAALRecipeBuilder> {
    private final Collection<GOResearchRecipeEntry> recipeGOEntries = new ArrayList<>();
    private boolean generatingRecipes = true;

    public GOAALRecipeBuilder() {}

    @SuppressWarnings("unused")
    public GOAALRecipeBuilder(Recipe recipe, RecipeMap<GOAALRecipeBuilder> recipeMap) {
        super(recipe, recipeMap);
    }

    public GOAALRecipeBuilder(@NotNull GOAALRecipeBuilder builder) {
        super(builder);
    ...
    @Override
    public GOAALRecipeBuilder copy() {
        return new GOAALRecipeBuilder(this);
    }
     ...
     */
    //
    public GOAALRecipeBuilder stationGOResearch(UnaryOperator<ResearchRecipeBuilder.StationRecipeBuilder> goresearch) {
