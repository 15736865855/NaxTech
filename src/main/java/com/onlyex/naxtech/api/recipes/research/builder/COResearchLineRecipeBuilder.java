...
public class COResearchLineRecipeBuilder extends RecipeBuilder<COResearchLineRecipeBuilder> {
    private final Collection<COResearchRecipeEntry> recipeCOEntries = new ArrayList<>();
    private boolean generatingRecipes = true;

    public COResearchLineRecipeBuilder() {}

    @SuppressWarnings("unused")
    public COResearchLineRecipeBuilder(Recipe recipe, RecipeMap<COResearchLineRecipeBuilder> recipeMap) {
        super(recipe, recipeMap);
    }

    public COResearchLineRecipeBuilder(@NotNull COResearchLineRecipeBuilder builder) {
        super(builder);
    ...
    @Override
    public COResearchLineRecipeBuilder copy() {
        return new COResearchLineRecipeBuilder(this);
    }
     ...
     */
    //
    public COResearchLineRecipeBuilder stationCOResearch(UnaryOperator<ResearchRecipeBuilder.StationRecipeBuilder> coresearch) {
    ...
    public static class COResearchRecipeEntry {
         ...
         *                      {@link #COResearchRecipeEntry(String, ItemStack, ItemStack, boolean, int, int
        ...
        public COResearchRecipeEntry(@NotNull String researchId, @NotNull ItemStack researchStack,
                                   @NotNull ItemStack dataStack, int duration, int EUt,
                                     int CWUt,int RWUt, int GORWUt, int OPRWUt, int SPRWUt, int CORWUt) {
