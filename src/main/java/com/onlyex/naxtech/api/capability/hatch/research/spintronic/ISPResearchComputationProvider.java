 ...
 * 该接口为多方块结构提供了计算相关的功能。
 */
public interface ISPResearchComputationProvider{
    ...
    default int requestSPRWUt(int sprwut, boolean simulate) {
        Collection<ISPResearchComputationProvider> list = new ArrayList<>();
        list.add(this);
     ...
     */
    int requestSPRWUt(int sprwut, boolean simulate, @NotNull Collection<ISPResearchComputationProvider> seen);
     ...
     * seen 参数表示已经检查过的光学计算提供者。
     */
    int getMaxSPRWUt(@NotNull Collection<ISPResearchComputationProvider> seen);
     ...
     * seen 参数表示已经检查过的光学计算提供者。
     */
    boolean canBridge(@NotNull Collection<ISPResearchComputationProvider> seen);
}
