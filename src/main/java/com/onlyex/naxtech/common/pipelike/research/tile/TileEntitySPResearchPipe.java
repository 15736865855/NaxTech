...
import com.onlyex.naxtech.common.pipelike.research.net.handler.SPResearchNetHandler;
...
public class TileEntitySPResearchPipe extends TileEntityPipeBase<ResearchPipeType, ResearchPipeProperties> {
    ...
    private void initHandlers() {
        ...
        for (EnumFacing facing : EnumFacing.VALUES) {
            handlers.put(facing, new SPResearchNetHandler(net, this, facing));
        }
        defaultHandler = new SPResearchNetHandler(net, this, null);
    }
    ...
    public <T> T getCapabilityInternal(Capability<T> capability, @Nullable EnumFacing facing) {
        ...
        if (capability == NTTileCapabilities.SP_CABABILITY_RESEARCH_PROVIDER) {
            if (world.isRemote) {
                return NTTileCapabilities.SP_CABABILITY_RESEARCH_PROVIDER.cast(clientComputationHandler);
            }

            if (handlers.isEmpty()) initHandlers();

            checkNetwork();
            return NTTileCapabilities.SP_CABABILITY_RESEARCH_PROVIDER
    ...
    public void checkNetwork() {
        if (defaultHandler != null) {
            ...
            if (defaultHandler.getNet() != current) {
                ...
                for (SPResearchNetHandler handler : handlers.values()) {
    ...
    public void transferDataFrom(IPipeTile<ResearchPipeType, ResearchPipeProperties> tileEntity) {
        ...
        if (getResearchPipeNet() == null)
            return;
        TileEntitySPResearchPipe pipe = (TileEntitySPResearchPipe) tileEntity;
