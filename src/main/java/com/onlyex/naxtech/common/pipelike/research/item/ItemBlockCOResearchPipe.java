...
public class ItemBlockCOResearchPipe extends ItemBlockPipe<ResearchPipeType, ResearchPipeProperties> {

    public ItemBlockCOResearchPipe(BlockCOResearchPipe block) {
        super(block);
    }
    ...
    public void addInformation(@NotNull ItemStack stack, @Nullable World worldIn, @NotNull List<String> tooltip,
        ...
        tooltip.add(I18n.format("tile.co_research_pipe_normal.tooltip1"));
