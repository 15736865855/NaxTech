...
import com.onlyex.naxtech.common.pipelike.research.block.BlockSCAResearchPipe;
...
public class ItemBlockSCAResearchPipe extends ItemBlockPipe<ResearchPipeType, ResearchPipeProperties> {

    public ItemBlockSCAResearchPipe(BlockSCAResearchPipe block) {
        super(block);
    }
    ...
    public void addInformation(@NotNull ItemStack stack, @Nullable World worldIn, @NotNull List<String> tooltip,
        ...
        tooltip.add(I18n.format("tile.sca_research_pipe_normal.tooltip1"));
