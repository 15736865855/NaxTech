...
import com.onlyex.naxtech.common.pipelike.research.block.BlockSCHResearchPipe;
...
public class ItemBlockSCHResearchPipe extends ItemBlockPipe<ResearchPipeType, ResearchPipeProperties> {

    public ItemBlockSCHResearchPipe(BlockSCHResearchPipe block) {
        super(block);
    }
    ...
    public void addInformation(@NotNull ItemStack stack, @Nullable World worldIn, @NotNull List<String> tooltip,
        ...
        tooltip.add(I18n.format("tile.sch_research_pipe_normal.tooltip1"));
