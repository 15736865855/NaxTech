...
import com.onlyex.naxtech.common.pipelike.research.block.BlockSDIResearchPipe;
...
public class ItemBlockSDIResearchPipe extends ItemBlockPipe<ResearchPipeType, ResearchPipeProperties> {

    public ItemBlockSDIResearchPipe(BlockSDIResearchPipe block) {
        super(block);
    }
