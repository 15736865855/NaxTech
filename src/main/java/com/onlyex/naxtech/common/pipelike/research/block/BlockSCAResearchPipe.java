...
import com.onlyex.naxtech.common.pipelike.research.item.ItemBlockSCAResearchPipe;
...
public class BlockSCAResearchPipe extends BlockPipe<ResearchPipeType, ResearchPipeProperties, WorldResearchPipeNet> {

    private final ResearchPipeType pipeType;
    private final ResearchPipeProperties properties;

    public BlockSCAResearchPipe(@NotNull ResearchPipeType pipeType) {
    ...
    protected Pair<TextureAtlasSprite, Integer> getParticleTexture(@NotNull World world, BlockPos blockPos) {
        return ResearchPipeRenderer.INSTANCE.getParticleTexture((TileEntitySCAResearchPipe) world.getTileEntity(blockPos));
    }
    ...
    public TileEntityPipeBase<ResearchPipeType, ResearchPipeProperties> createNewTileEntity(boolean supportsTicking) {
        return new TileEntitySCAResearchPipe();
    }
    ...
    public ResearchPipeProperties createItemProperties(@NotNull ItemStack itemStack) {
        if (itemStack.getItem() instanceof ItemBlockSCAResearchPipe pipe) {
            return ((BlockSCAResearchPipe) pipe.getBlock()).properties;
        }
        return null;
    }
    ...
    public ResearchPipeType getItemPipeType(@NotNull ItemStack itemStack) {
        if (itemStack.getItem() instanceof ItemBlockSCAResearchPipe pipe) {
            return ((BlockSCAResearchPipe) pipe.getBlock()).pipeType;
        }
        return null;
    }
    ...
    public boolean canPipesConnect(IPipeTile<ResearchPipeType, ResearchPipeProperties> selfTile, EnumFacing side,
        ...
        return selfTile instanceof TileEntitySCAResearchPipe && sideTile instanceof TileEntitySCAResearchPipe;
    }
    ...
    public boolean isHoldingPipe(EntityPlayer player) {
        ...
        return stack != ItemStack.EMPTY && stack.getItem() instanceof ItemBlockSCAResearchPipe;
    }
