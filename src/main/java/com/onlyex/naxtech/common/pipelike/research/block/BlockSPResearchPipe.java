...
import com.onlyex.naxtech.common.pipelike.research.item.ItemBlockSPResearchPipe;
...
public class BlockSPResearchPipe extends BlockPipe<ResearchPipeType, ResearchPipeProperties, WorldResearchPipeNet> {

    private final ResearchPipeType pipeType;
    private final ResearchPipeProperties properties;

    public BlockSPResearchPipe(@NotNull ResearchPipeType pipeType) {
    ...
    protected Pair<TextureAtlasSprite, Integer> getParticleTexture(@NotNull World world, BlockPos blockPos) {
        return ResearchPipeRenderer.INSTANCE.getParticleTexture((TileEntitySPResearchPipe) world.getTileEntity(blockPos));
    }
    ...
    public TileEntityPipeBase<ResearchPipeType, ResearchPipeProperties> createNewTileEntity(boolean supportsTicking) {
        return new TileEntitySPResearchPipe();
    }
    ...
    public ResearchPipeProperties createItemProperties(@NotNull ItemStack itemStack) {
        if (itemStack.getItem() instanceof ItemBlockSPResearchPipe pipe) {
            return ((BlockSPResearchPipe) pipe.getBlock()).properties;
        }
        return null;
    }
    ...
    public ResearchPipeType getItemPipeType(@NotNull ItemStack itemStack) {
        if (itemStack.getItem() instanceof ItemBlockSPResearchPipe pipe) {
            return ((BlockSPResearchPipe) pipe.getBlock()).pipeType;
        }
        return null;
    }
    ...
    public boolean canPipesConnect(IPipeTile<ResearchPipeType, ResearchPipeProperties> selfTile, EnumFacing side,
        ...
        return selfTile instanceof TileEntitySPResearchPipe && sideTile instanceof TileEntitySPResearchPipe;
    }
    ...
    public boolean isHoldingPipe(EntityPlayer player) {
        ...
        return stack != ItemStack.EMPTY && stack.getItem() instanceof ItemBlockSPResearchPipe;
    }
