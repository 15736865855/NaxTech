...
import com.onlyex.naxtech.common.pipelike.research.item.ItemBlockSCHResearchPipe;
...
public class BlockSCHResearchPipe extends BlockPipe<ResearchPipeType, ResearchPipeProperties, WorldResearchPipeNet> {

    private final ResearchPipeType pipeType;
    private final ResearchPipeProperties properties;

    public BlockSCHResearchPipe(@NotNull ResearchPipeType pipeType) {
    ...
    protected Pair<TextureAtlasSprite, Integer> getParticleTexture(@NotNull World world, BlockPos blockPos) {
        return ResearchPipeRenderer.INSTANCE.getParticleTexture((TileEntitySCHResearchPipe) world.getTileEntity(blockPos));
    }
    ...
    public TileEntityPipeBase<ResearchPipeType, ResearchPipeProperties> createNewTileEntity(boolean supportsTicking) {
        return new TileEntitySCHResearchPipe();
    }
    ...
    public ResearchPipeProperties createItemProperties(@NotNull ItemStack itemStack) {
        if (itemStack.getItem() instanceof ItemBlockSCHResearchPipe pipe) {
            return ((BlockSCHResearchPipe) pipe.getBlock()).properties;
        }
        return null;
    }
    ...
    public ResearchPipeType getItemPipeType(@NotNull ItemStack itemStack) {
        if (itemStack.getItem() instanceof ItemBlockSCHResearchPipe pipe) {
            return ((BlockSCHResearchPipe) pipe.getBlock()).pipeType;
        }
        return null;
    }
    ...
    public boolean canPipesConnect(IPipeTile<ResearchPipeType, ResearchPipeProperties> selfTile, EnumFacing side,
        ...
        return selfTile instanceof TileEntitySCHResearchPipe && sideTile instanceof TileEntitySCHResearchPipe;
    }
    ...
    public boolean isHoldingPipe(EntityPlayer player) {
        ...
        return stack != ItemStack.EMPTY && stack.getItem() instanceof ItemBlockSCHResearchPipe;
    }
