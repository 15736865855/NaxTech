...
public class BlockResearchPipe extends BlockPipe<ResearchPipeType, ResearchPipeProperties, WorldResearchPipeNet> {
    ...
    protected Pair<TextureAtlasSprite, Integer> getParticleTexture(@NotNull World world, BlockPos blockPos) {
        return ResearchPipeRenderer.INSTANCE.getParticleTexture((TileEntityResearchPipe) world.getTileEntity(blockPos));
    }
    ...
    public TileEntityPipeBase<ResearchPipeType, ResearchPipeProperties> createNewTileEntity(boolean supportsTicking) {
        return new TileEntityResearchPipe();
    }
    ...
    public ResearchPipeProperties createItemProperties(@NotNull ItemStack itemStack) {
        if (itemStack.getItem() instanceof ItemBlockResearchPipe pipe) {
            return ((BlockResearchPipe) pipe.getBlock()).properties;
        }
        return null;
    }
    ...
    public ResearchPipeType getItemPipeType(@NotNull ItemStack itemStack) {
        if (itemStack.getItem() instanceof ItemBlockResearchPipe pipe) {
            return ((BlockResearchPipe) pipe.getBlock()).pipeType;
        }
        return null;
    }
    ...
    public boolean canPipesConnect(IPipeTile<ResearchPipeType, ResearchPipeProperties> selfTile, EnumFacing side,
        ...
        return selfTile instanceof TileEntityResearchPipe && sideTile instanceof TileEntityResearchPipe;
    }
    ...
    public boolean canPipeConnectToBlock(IPipeTile<ResearchPipeType, ResearchPipeProperties> selfTile, EnumFacing side,
        ...
        return tile.hasCapability(NTTileCapabilities.CABABILITY_COMPUTATION_PROVIDER, side.getOpposite());
    }
    ...
    public boolean isHoldingPipe(EntityPlayer player) {
        ...
        return stack != ItemStack.EMPTY && stack.getItem() instanceof ItemBlockResearchPipe;
    }
