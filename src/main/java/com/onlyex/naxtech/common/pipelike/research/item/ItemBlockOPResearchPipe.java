...
import com.onlyex.naxtech.common.pipelike.research.block.BlockOPResearchPipe;
...
public class ItemBlockOPResearchPipe extends ItemBlockPipe<ResearchPipeType, ResearchPipeProperties> {

    public ItemBlockOPResearchPipe(BlockOPResearchPipe block) {
        super(block);
    }
    ...
    public void addInformation(@NotNull ItemStack stack, @Nullable World worldIn, @NotNull List<String> tooltip,
        ...
        tooltip.add(I18n.format("tile.op_research_pipe_normal.tooltip1"));
