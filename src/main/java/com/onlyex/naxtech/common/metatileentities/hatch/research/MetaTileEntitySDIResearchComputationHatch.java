...
public class MetaTileEntitySDIResearchComputationHatch extends MetaTileEntityMultiblockPart implements
                                            IMultiblockAbilityPart<ISDIResearchComputationHatch>, ISDIResearchComputationHatch {

    private final boolean isTransmitter;

    public MetaTileEntitySDIResearchComputationHatch(ResourceLocation metaTileEntityId, boolean isTransmitter) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntitySDIResearchComputationHatch(metaTileEntityId, isTransmitter);
    }
    ...
    @Override
    public int requestSDIRWUt(int sdirwut, boolean simulate, @NotNull Collection<ISDIResearchComputationProvider> seenProviders) {
        ...
        if (isTransmitter()) {
            // 向多方块控制器发送请求RWUt值的请求
            if (multiblockController instanceof ISDIResearchComputationProvider computationProvider) {
            ...
            ISDIResearchComputationProvider computationProvider = getResearchNetProvider();
    ...
    @Override
    public int getMaxSDIRWUt(@NotNull Collection<ISDIResearchComputationProvider> seenProviders) {
        seenProviders.add(this);
        var multiblockController = getController();
    ...
    public boolean canBridge(@NotNull Collection<ISDIResearchComputationProvider> seen) {
        ...
        if (isTransmitter()) {
            ...
            if (controller instanceof ISDIResearchComputationProvider provider) {
            ...
            ISDIResearchComputationProvider provider = getResearchNetProvider();
            if (provider == null) {
    ...
    @Nullable
    private ISDIResearchComputationProvider getResearchNetProvider() {
    ...
    @Override
    public MultiblockAbility<ISDIResearchComputationHatch> getAbility() {
    ...
    @Override
    public void registerAbilities(List<ISDIResearchComputationHatch> abilityList) {
