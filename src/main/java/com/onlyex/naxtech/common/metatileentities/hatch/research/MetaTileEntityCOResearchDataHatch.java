...
public class MetaTileEntityCOResearchDataHatch extends MetaTileEntityMultiblockPart implements
                                            IMultiblockAbilityPart<ICOResearchDataHatch>, ICOResearchDataHatch {

    private final boolean isTransmitter;

    public MetaTileEntityCOResearchDataHatch(ResourceLocation metaTileEntityId, boolean isTransmitter) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityCOResearchDataHatch(metaTileEntityId, isTransmitter);
    }
    ...
    @Override
    public int requestCORWUt(int corwut, boolean simulate, @NotNull Collection<ICOResearchDataProvider> seenProviders) {
        ...
        if (isTransmitter()) {
            // 向多方块控制器发送请求RWUt值的请求
            if (multiblockController instanceof ICOResearchDataProvider computationProvider) {
            ...
            ICOResearchDataProvider computationProvider = getResearchNetProvider();
    ...
    @Override
    public int getMaxCORWUt(@NotNull Collection<ICOResearchDataProvider> seenProviders) {
        seenProviders.add(this);
        var multiblockController = getController();
    ...
    public boolean canBridge(@NotNull Collection<ICOResearchDataProvider> seen) {
        ...
        if (isTransmitter()) {
            ...
            if (controller instanceof ICOResearchDataProvider provider) {
            ...
            ICOResearchDataProvider provider = getResearchNetProvider();
            if (provider == null) {
    ...
    @Nullable
    private ICOResearchDataProvider getResearchNetProvider() {
    ...
    @Override
    public MultiblockAbility<ICOResearchDataHatch> getAbility() {
    ...
    @Override
    public void registerAbilities(List<ICOResearchDataHatch> abilityList) {
