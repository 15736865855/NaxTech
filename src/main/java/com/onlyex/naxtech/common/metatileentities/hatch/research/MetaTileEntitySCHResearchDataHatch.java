...
public class MetaTileEntitySCHResearchDataHatch extends MetaTileEntityMultiblockPart implements
                                            IMultiblockAbilityPart<ISCHResearchDataHatch>, ISCHResearchDataHatch {

    private final boolean isTransmitter;

    public MetaTileEntitySCHResearchDataHatch(ResourceLocation metaTileEntityId, boolean isTransmitter) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntitySCHResearchDataHatch(metaTileEntityId, isTransmitter);
    }
    ...
    @Override
    public int requestSCHRWUt(int schrwut, boolean simulate, @NotNull Collection<ISCHResearchDataProvider> seenProviders) {
        ...
        if (isTransmitter()) {
            // 向多方块控制器发送请求RWUt值的请求
            if (multiblockController instanceof ISCHResearchDataProvider computationProvider) {
            ...
            ISCHResearchDataProvider computationProvider = getResearchNetProvider();
    ...
    @Override
    public int getMaxSCHRWUt(@NotNull Collection<ISCHResearchDataProvider> seenProviders) {
        seenProviders.add(this);
        var multiblockController = getController();
    ...
    public boolean canBridge(@NotNull Collection<ISCHResearchDataProvider> seen) {
        ...
        if (isTransmitter()) {
            ...
            if (controller instanceof ISCHResearchDataProvider provider) {
            ...
            ISCHResearchDataProvider provider = getResearchNetProvider();
            if (provider == null) {
    ...
    @Nullable
    private ISCHResearchDataProvider getResearchNetProvider() {
    ...
    @Override
    public MultiblockAbility<ISCHResearchDataHatch> getAbility() {
    ...
    @Override
    public void registerAbilities(List<ISCHResearchDataHatch> abilityList) {
