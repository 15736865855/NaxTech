package com.onlyex.naxtech.common.metatileentities.multi.industry;
...
public class MetaTileEntityHugeCrackingUnit extends RecipeMapMultiblockController {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('G', NTTraceabilityPredicate.LE_GLASS.get())
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (this.isStructureFormed()) {
            ...
            textList.add(new TextComponentTranslation("naxtech.multiblock.md.level", heatingCoilLevel));
            textList.add(new TextComponentTranslation("naxtech.multiblock.md.glass", glassTire));
            textList.add(new TextComponentTranslation("naxtech.multiblock.fu.level", 100-10*glassTire));
        }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.multiblock.hb.tooltip.1"));
        tooltip.add(I18n.format("naxtech.multiblock.hb.tooltip.2"));
        tooltip.add(I18n.format("naxtech.multiblock.hb.tooltip.3"));
        tooltip.add(I18n.format("naxtech.multiblock.ab.tooltip.1"));
        tooltip.add(I18n.format("naxtech.multiblock.ab.tooltip.2", 768));
    ...
    protected void formStructure(PatternMatchContext context) {
        ...
        this.glassTire = NTUniverUtil.getOrDefault(() -> glassTire instanceof WrappedIntTier,
                () -> ((WrappedIntTier)glassTire).getIntTier(),
                0);
