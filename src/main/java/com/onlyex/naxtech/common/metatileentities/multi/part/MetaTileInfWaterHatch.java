...
import com.onlyex.naxtech.api.capability.InfFluidTank;
...
public class MetaTileInfWaterHatch extends MetaTileEntityMultiblockNotifiablePart implements IMultiblockAbilityPart<IFluidTank> {
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        if(this.shouldRenderOverlay()){
            NTTextures.INF_WATER.renderSided(getFrontFacing(),renderState,translation,pipeline);
        }
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.tooltip.inf_water1"));
        tooltip.add(I18n.format("naxtech.tooltip.inf_water2"));
        tooltip.add(I18n.format("naxtech.tooltip.inf_water3"));
    }
}