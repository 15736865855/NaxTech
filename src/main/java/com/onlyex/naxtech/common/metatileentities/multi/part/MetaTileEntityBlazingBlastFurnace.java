...
import static com.onlyex.naxtech.api.unification.NTMaterials.BlazingPyrotheum;
...
public class MetaTileEntityBlazingBlastFurnace extends RecipeMapMultiblockController implements IHeatingCoil {
    ...
    protected IBlockState getCasingState() {
        return NTMetaBlocks.MACHINE_CASING.getState(BlockMachinelCasing.CasingType.ADVANCED_INVAR_CASING);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.machine.blazing_blast_furnace.tooltip.1"));
        tooltip.add(I18n.format("naxtech.machine.blazing_blast_furnace.tooltip.2"));
        tooltip.add(I18n.format("naxtech.machine.blazing_blast_furnace.tooltip.3"));
        tooltip.add(I18n.format("naxtech.machine.blazing_blast_furnace.tooltip.4"));
    }
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        if (isStructureFormed()) {
            ...
            if (getInputFluidInventory() != null) {
                ...
                textList.add(new TextComponentTranslation("naxtech.machine.blazing_blast_furnace.amount", TextFormattingUtil.formatNumbers((liquidOxygenAmount))));
                textList.add(new TextComponentTranslation("naxtech.machine.blazing_blast_furnace.heat"));
            }
    ...
    protected void addWarningText(List<ITextComponent> textList) {
        ...
        if (isStructureFormed()) {
            ...
            if (lubricantStack == null || lubricantStack.amount == 0) {
                textList.add(new TextComponentTranslation("naxtech.machine.blazing_blast_furnace.warning"));
            }
        }
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        return NTTextures.ADVANCED_INVAR_CASING;
    }
