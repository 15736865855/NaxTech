...
public class MetaTileEntityResearchDataHatch extends MetaTileEntityMultiblockPart implements
                                            IMultiblockAbilityPart<IResearchDataHatch>, IResearchDataHatch {

    private final boolean isTransmitter;

    public MetaTileEntityResearchDataHatch(ResourceLocation metaTileEntityId, boolean isTransmitter) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityResearchDataHatch(metaTileEntityId, isTransmitter);
    }
    ...
    @Override
    public int requestRWUt(int rwut, boolean simulate, @NotNull Collection<IResearchDataProvider> seenProviders) {
        ...
        if (isTransmitter()) {
            // 向多方块控制器发送请求RWUt值的请求
            if (multiblockController instanceof IResearchDataProvider computationProvider) {
            ...
            IResearchDataProvider computationProvider = getResearchNetProvider();
    ...
    @Override
    public int getMaxRWUt(@NotNull Collection<IResearchDataProvider> seenProviders) {
        seenProviders.add(this);
        var multiblockController = getController();
    ...
    public boolean canBridge(@NotNull Collection<IResearchDataProvider> seen) {
        ...
        if (isTransmitter()) {
            ...
            if (controller instanceof IResearchDataProvider provider) {
            ...
            IResearchDataProvider provider = getResearchNetProvider();
            if (provider == null) {
    ...
    @Nullable
    private IResearchDataProvider getResearchNetProvider() {
    ...
    @Override
    public void registerAbilities(List<IResearchDataHatch> abilityList) {
