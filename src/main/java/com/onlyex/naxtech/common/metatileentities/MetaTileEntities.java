...
public class MetaTileEntities {
    ...
    //仓口-hatch
    //-research
    public static MetaTileEntityResearchDataHatch RESEARCH_COMPUTATION_HATCH_RECEIVER;
    public static MetaTileEntityResearchDataHatch RESEARCH_COMPUTATION_HATCH_TRANSMITTER;
    public static MetaTileEntityGOResearchDataHatch GO_RESEARCH_COMPUTATION_HATCH_RECEIVER;
    public static MetaTileEntityGOResearchDataHatch GO_RESEARCH_COMPUTATION_HATCH_TRANSMITTER;
    public static MetaTileEntityOPResearchDataHatch OP_RESEARCH_COMPUTATION_HATCH_RECEIVER;
    public static MetaTileEntityOPResearchDataHatch OP_RESEARCH_COMPUTATION_HATCH_TRANSMITTER;
    public static MetaTileEntitySPResearchDataHatch SP_RESEARCH_COMPUTATION_HATCH_RECEIVER;
    public static MetaTileEntitySPResearchDataHatch SP_RESEARCH_COMPUTATION_HATCH_TRANSMITTER;
    public static MetaTileEntityCOResearchDataHatch CO_RESEARCH_COMPUTATION_HATCH_RECEIVER;
    public static MetaTileEntityCOResearchDataHatch CO_RESEARCH_COMPUTATION_HATCH_TRANSMITTER;
    public static MetaTileEntitySCAResearchDataHatch SCA_RESEARCH_COMPUTATION_HATCH_RECEIVER;
    public static MetaTileEntitySCAResearchDataHatch SCA_RESEARCH_COMPUTATION_HATCH_TRANSMITTER;
    public static MetaTileEntitySCHResearchDataHatch SCH_RESEARCH_COMPUTATION_HATCH_RECEIVER;
    public static MetaTileEntitySCHResearchDataHatch SCH_RESEARCH_COMPUTATION_HATCH_TRANSMITTER;
    public static MetaTileEntitySDIResearchDataHatch SDI_RESEARCH_COMPUTATION_HATCH_RECEIVER;
    public static MetaTileEntitySDIResearchDataHatch SDI_RESEARCH_COMPUTATION_HATCH_TRANSMITTER;
    ...
    public static void init() {
        ...
        RESEARCH_COMPUTATION_HATCH_RECEIVER = registerSingleMetaTileEntity(33,
                new MetaTileEntityResearchDataHatch(naxId("research_computation_hatch.receiver"), false));
        RESEARCH_COMPUTATION_HATCH_TRANSMITTER = registerSingleMetaTileEntity(34,
                new MetaTileEntityResearchDataHatch(naxId("research_computation_hatch.transmitter"), true));

        GO_RESEARCH_COMPUTATION_HATCH_RECEIVER = registerSingleMetaTileEntity(35,
                new MetaTileEntityGOResearchDataHatch(naxId("go_research_computation_hatch.receiver"), false));
        GO_RESEARCH_COMPUTATION_HATCH_TRANSMITTER = registerSingleMetaTileEntity(36,
                new MetaTileEntityGOResearchDataHatch(naxId("go_research_computation_hatch.transmitter"), true));

        OP_RESEARCH_COMPUTATION_HATCH_RECEIVER = registerSingleMetaTileEntity(37,
                new MetaTileEntityOPResearchDataHatch(naxId("op_research_computation_hatch.receiver"), false));
        OP_RESEARCH_COMPUTATION_HATCH_TRANSMITTER = registerSingleMetaTileEntity(38,
                new MetaTileEntityOPResearchDataHatch(naxId("op_research_computation_hatch.transmitter"), true));

        SP_RESEARCH_COMPUTATION_HATCH_RECEIVER = registerSingleMetaTileEntity(39,
                new MetaTileEntitySPResearchDataHatch(naxId("sp_research_computation_hatch.receiver"), false));
        SP_RESEARCH_COMPUTATION_HATCH_TRANSMITTER = registerSingleMetaTileEntity(40,
                new MetaTileEntitySPResearchDataHatch(naxId("sp_research_computation_hatch.transmitter"), true));

        CO_RESEARCH_COMPUTATION_HATCH_RECEIVER = registerSingleMetaTileEntity(41,
                new MetaTileEntityCOResearchDataHatch(naxId("co_research_computation_hatch.receiver"), false));
        CO_RESEARCH_COMPUTATION_HATCH_TRANSMITTER = registerSingleMetaTileEntity(42,
                new MetaTileEntityCOResearchDataHatch(naxId("co_research_computation_hatch.transmitter"), true));

        SCA_RESEARCH_COMPUTATION_HATCH_RECEIVER = registerSingleMetaTileEntity(43,
                new MetaTileEntitySCAResearchDataHatch(naxId("sca_research_computation_hatch.receiver"), false));
        SCA_RESEARCH_COMPUTATION_HATCH_TRANSMITTER = registerSingleMetaTileEntity(44,
                new MetaTileEntitySCAResearchDataHatch(naxId("sca_research_computation_hatch.transmitter"), true));

        SCH_RESEARCH_COMPUTATION_HATCH_RECEIVER = registerSingleMetaTileEntity(45,
                new MetaTileEntitySCHResearchDataHatch(naxId("sch_research_computation_hatch.receiver"), false));
        SCH_RESEARCH_COMPUTATION_HATCH_TRANSMITTER = registerSingleMetaTileEntity(46,
                new MetaTileEntitySCHResearchDataHatch(naxId("sch_research_computation_hatch.transmitter"), true));

        SDI_RESEARCH_COMPUTATION_HATCH_RECEIVER = registerSingleMetaTileEntity(47,
                new MetaTileEntitySDIResearchDataHatch(naxId("sdi_research_computation_hatch.receiver"), false));
        SDI_RESEARCH_COMPUTATION_HATCH_TRANSMITTER = registerSingleMetaTileEntity(48,
                new MetaTileEntitySDIResearchDataHatch(naxId("sdi_research_computation_hatch.transmitter"), true));
