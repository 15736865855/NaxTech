...
public class MetaTileEntityGOResearchComputationHatch extends MetaTileEntityMultiblockPart implements
                                            IMultiblockAbilityPart<IGOResearchComputationHatch>, IGOResearchComputationHatch {

    private final boolean isTransmitter;

    public MetaTileEntityGOResearchComputationHatch(ResourceLocation metaTileEntityId, boolean isTransmitter) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityGOResearchComputationHatch(metaTileEntityId, isTransmitter);
    }
    ...
    @Override
    public int requestGORWUt(int gorwut, boolean simulate, @NotNull Collection<IGOResearchComputationProvider> seenProviders) {
        ...
        if (isTransmitter()) {
            // 向多方块控制器发送请求RWUt值的请求
            if (multiblockController instanceof IGOResearchComputationProvider computationProvider) {
            ...
            IGOResearchComputationProvider computationProvider = getResearchNetProvider();
    ...
    @Override
    public int getMaxGORWUt(@NotNull Collection<IGOResearchComputationProvider> seenProviders) {
        seenProviders.add(this);
        var multiblockController = getController();
    ...
    public boolean canBridge(@NotNull Collection<IGOResearchComputationProvider> seen) {
        ...
        if (isTransmitter()) {
            ...
            if (controller instanceof IGOResearchComputationProvider provider) {
            ...
            IGOResearchComputationProvider provider = getResearchNetProvider();
            if (provider == null) {
    ...
    @Nullable
    private IGOResearchComputationProvider getResearchNetProvider() {
    ...
    @Override
    public MultiblockAbility<IGOResearchComputationHatch> getAbility() {
    ...
    @Override
    public void registerAbilities(List<IGOResearchComputationHatch> abilityList) {
