...
public class MetaTileEntityOPResearchComputationHatch extends MetaTileEntityMultiblockPart implements
                                            IMultiblockAbilityPart<IOPResearchComputationHatch>, IOPResearchComputationHatch {

    private final boolean isTransmitter;

    public MetaTileEntityOPResearchComputationHatch(ResourceLocation metaTileEntityId, boolean isTransmitter) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityOPResearchComputationHatch(metaTileEntityId, isTransmitter);
    }
    ...
    @Override
    public int requestOPRWUt(int oprwut, boolean simulate, @NotNull Collection<IOPResearchComputationProvider> seenProviders) {
        ...
        if (isTransmitter()) {
            // 向多方块控制器发送请求RWUt值的请求
            if (multiblockController instanceof IOPResearchComputationProvider computationProvider) {
            ...
            IOPResearchComputationProvider computationProvider = getResearchNetProvider();
    ...
    @Override
    public int getMaxOPRWUt(@NotNull Collection<IOPResearchComputationProvider> seenProviders) {
        seenProviders.add(this);
        var multiblockController = getController();
    ...
    public boolean canBridge(@NotNull Collection<IOPResearchComputationProvider> seen) {
        ...
        if (isTransmitter()) {
            ...
            if (controller instanceof IOPResearchComputationProvider provider) {
            ...
            IOPResearchComputationProvider provider = getResearchNetProvider();
            if (provider == null) {
    ...
    @Nullable
    private IOPResearchComputationProvider getResearchNetProvider() {
    ...
    @Override
    public MultiblockAbility<IOPResearchComputationHatch> getAbility() {
    ...
    @Override
    public void registerAbilities(List<IOPResearchComputationHatch> abilityList) {
